...
class EventTile extends StatefulWidget {
  ...
  EventTile({required this.eventDate,
...
class _EventTile extends State<EventTile> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        widget.updateState();
        if (widget.choosenDate.day <= DateTime
            .now()
            .day) {
            ...
            title: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "You can start this task from ${DateFormat.MMMM().format(
                        DateTime.parse(
                            widget.choosenDate.toIso8601String()))} ${widget
                        .choosenDate.day}th ",
                    style: GoogleFonts.montserrat(
                        fontWeight: FontWeight.w400,
                        fontSize: 20,
