...
enum EventProccess {
  progress("In Progress", Color(0xffD2C5DF), Color(0xff8675A9), Icon(Icons.refresh_outlined, color: Color(0xff8675A9), size: 16,)),
  completed("Completed", Color(0xffCEE5D0), Color(0xff94B49F), Icon(Icons.check_outlined, color: Color(0xff94B49F), size: 16,)),
