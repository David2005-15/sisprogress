                ...
                children: [
                  Column(
                    children: <Widget>[
                      ...
                      widget.mode ? Column(
                        children: [
                          InputBox(textInputType: TextInputType.text,
                            onChanged: (val) {},
                            context: context,
                            ...
                            Row(
                                    ...
                                    children: <Widget> [
                                      ...
                                      Button(text: "Update", onPressed: () {
                                        httpClient.sendUpdateEmail(primaryEmail.text);
                      ...
                      widget.mode ? isSecondaryEmail ? Column(
                        children: [
                          InputBox(textInputType: TextInputType.text,
                            onChanged: (val) {},
                            context: context,
                            ...
                            Row(
                              ...
                              children: <Widget> [
                                Container(),
                                Button(text: "Update", onPressed: () {changeEmail(secondaryEmail.text, "Secondary");}, height: 38, width: 116)
                              ],
                            )
                        ],
                      ) : Container() : Container(),
                      ...
                      widget.mode ? isSecondaryEmail ? InkWell(
                        onTap: () {
                          state(() {
                ...
                child: Column(
                  children: [
                    RichText(
                      ...
                      text: TextSpan(
                        text: 'Yeah! ',
                        style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 15, color: const Color(0xff355CCA)),
                        children:  <TextSpan>[
                          TextSpan(text: 'The $which email has been\nchanged.', style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 15, color: Colors.white)),
                        ],
                      ),
                    ),
              
                    Button(text: "OK", onPressed: () {Navigator.pop(context);}, height: 36, width: 145)
                  ],
                ),
              ),
            );
                  ...
                  children: <Widget> [
                    ...
                    Container(
                      ...
                      child: VerificationCode(
                        ...
                        underlineUnfocusedColor: const Color(0xffD2DAFF), // If this is null it will use primaryColor: Colors.red from Theme
                        length: 6,
                    ...
                    Button(text: "Submit", onPressed: _code != null ? () {
                      state(() {
                        httpClient.sendCode(email, _code!);
                        Navigator.pop(context);
                        successMessage(whichEmail);
                      });
                    }: null, height: 36, width: 175),
    ...
    return Container(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.transparent, border: Border.all(width: 1, color: selected ? const Color(0xff355CCA): const Color(0xffBFBFBF))),
           child: Icon(
            Icons.circle,
              size: 14,
